...
async function getPending(req, res) {
  ...
  const nMap = { core_team:"status='pending_core'", div_head:`status='pending_divhead' AND division_key='${division_key}'`, cfo:"status='pending_cfo'", sg:"status='pending_sg'", admin:"status LIKE 'pending_%'", pl:`(status='sent_back') AND created_by='${id}'`, cbod_team:"1=0", accounts:"1=0" };
